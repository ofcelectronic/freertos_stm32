...
void Startnormal(void const * argument);
...
int main(void)
{
  ...
  osThreadDef(NormalTask, Startnormal, osPriorityNormal, 0, 128);
...
/* USER CODE BEGIN Header_Startnormal */
/**
  * @brief  Function implementing the NormalTask thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_Startnormal */
void Startnormal(void const * argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
